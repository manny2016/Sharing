...
namespace Sharing.Agent.Delivery {
	...
	public static class OnlineOrderExtension {
		...
		private static bool PrintBilling(this OnlineOrder order, string printer) {
			...
			document.PrinterSettings.DefaultPageSettings.PaperSize = new PaperSize("Bill", 0,0);
			document.PrinterSettings.DefaultPageSettings.Margins = new Margins(50, 50, 50, 0);
